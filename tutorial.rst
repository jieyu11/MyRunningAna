...
----------------
  ...
  1. Check the fitparse in python: `fitparse <https://github.com/dtcooper/python-fitparse>`_. 
  2. Check also below as reference: `fitparse reference <http://dtcooper.github.io/python-fitparse/>`_.
  3. Do: pip install fitparse
...
-------------------------------
  ...
  + As of May 25th, 2018, Strava provides the option to export an archive of your account. Find here: `strave data bulk export <https://support.strava.com/hc/en-us/articles/216918437-Exporting-your-Data-and-Bulk-Export>`_.
    ...
    4. Select "Request your archive" on the next page. You will receive an email with a link to download your data (this may take a few hours.) For this reason, it's important that you have access to the email account attached to your Strava profile.
...
Run Analysis of one single run
------------------------------

Single run analysis is simple:

  + python2.7 read_fit.py data/test.fit OUTDIR


Run Analysis of multiple runs
-----------------------------

The list of runs can be put in a folder InputDIR or a input file with each line the (.fit) input name.

  + python2.7 read_sequence.py InputDIR OUTDIR
